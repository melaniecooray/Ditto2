 ...
 */
    ...
    func setupPasswordTextField() {
        passwordTextField = SkyFloatingLabelTextField(frame: CGRect(x: view.frame.width/8, y: emailTextField.frame.maxY * 15/14, width: view.frame.width * 3/4, height: view.frame.height/12))
